...
DocMeta.setdocmeta!(AeroGeometry, :DocTestSetup, :(using AeroGeometry); recursive = true)
...
makedocs(;
    ...
    format = Documenter.HTML(; canonical = "https://antoniosgeme.github.io/AeroGeometry.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/antoniosgeme/AeroGeometry.jl")
